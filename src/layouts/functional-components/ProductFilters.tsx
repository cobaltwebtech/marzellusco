...
const ProductFilters = ({
	...
	return (
		<div>
			<div>
				<h5 className="mb-2 font-bold lg:text-xl">Select Price Range</h5>
			...
			<div>
				<h5 className="mt-4 mb-2 font-bold lg:mt-6 lg:text-xl">
					Product Categories
				</h5>
				<hr className="dark:border-darkmode-border" />
			...
			{vendors && (
				<div>
					<h5 className="mt-8 mb-2 font-bold lg:mt-10 lg:text-xl">Brands</h5>
					<hr className="dark:border-darkmode-border" />
					<ul className="mt-4 space-y-4">
						{vendors.map((vendor) => (
							<li
								key={vendor.vendor}
								className={`text-light dark:text-darkmode-light flex cursor-pointer items-center justify-between`}
							...
							>
								...
								<div className="border-light dark:border-darkmode-light flex h-4 w-4 items-center justify-center rounded-sm border">
			...
			{tags.length > 0 && (
				<div>
					<h5 className="mt-8 mb-2 font-bold lg:mt-10 lg:text-xl">Tags</h5>
					<hr className="dark:border-darkmode-border" />
					<div className="mt-4">
						<ShowTags tags={tags} />
					</div>
