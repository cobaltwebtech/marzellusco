	...
	return (
		<form onSubmit={handleSubmit}>
			<button
				...
				disabled={pending}
				className={`ease flex h-full max-w-[36px] min-w-[36px] items-center justify-center rounded-full px-2 transition-all duration-200 hover:border-neutral-800 hover:opacity-80 ${
					type === "minus" ? "ml-auto" : ""
